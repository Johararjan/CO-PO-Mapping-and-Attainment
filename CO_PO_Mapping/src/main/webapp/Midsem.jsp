...
<td><%=rs.getInt(3) %></td>
<td><input type="number" name="q1marks<%=Integer.toString(j)%>" value="6"></td>

<td><input type="number" name="q2marks<%=Integer.toString(j)%>" value="6"></td>
<td><input type="number" name="q3marks<%=Integer.toString(j)%>" value="8"></td>
...
%>
<tr><td colspan="7"><button type="submit" class="butn button_slide slide_left">Print Mid Sem Analysis</button></td></tr>
</table>
