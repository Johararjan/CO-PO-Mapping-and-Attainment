...
<tr>
<td><input type="text" name="11" class="form-input"></td>
<td><input type="text" name="t11" class="form-input"></td>
</tr>
<tr>
<td><input type="text" name="12" class="form-input"></td>
<td><input type="text" name="t12" class="form-input"></td>
</tr>
<tr>
<td><input type="text" name="13" class="form-input"></td>
<td><input type="text" name="t13" class="form-input"></td>
</tr>
...
try {
	...
	String sql="insert into tysem1 values(?,?)";
