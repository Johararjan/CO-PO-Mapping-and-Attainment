<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    //response.setHeader("Content-Disposition", "attachment;filename=ca1.xls");%>
<!DOCTYPE html>
<html>
<head>
...
try {
	...
	PreparedStatement stm=connection.prepareStatement("select ca1 from student where year=?");
	stm.setInt(1,year);
...
try {
	...
	Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/copomapping","root","@Arjan196");
	Statement stmt=connection.createStatement(); 
	PreparedStatement stm=connection.prepareStatement("insert into ca1 values(?,?,?,?,?)");
